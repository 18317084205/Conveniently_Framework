...
public abstract class AbstractResponse<T> implements IResponse<T> {
	...
	public T parse(HttpURLConnection connection,
		...
		try {
			...
			// TODO normally 200 represent success, but you should know 200-299
			// all means success, please ensure with your backend colleagues
	...
	public IResponse<T> setCachePath(String path) {
		this.path = path;
		return this;
	}
